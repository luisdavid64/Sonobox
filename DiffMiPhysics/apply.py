...
if __name__ == "__main__":
    ...
    # parser.add_argument("--text_target", type=str, default='violin playing paganini', help="Text description to match.")
    parser.add_argument("--text_target", type=str, default='piano like staccato', help="Text description to match.")
    ...
    parser.add_argument("--n_iters", type=int, default=400, help="Number of optimization iterations.")
